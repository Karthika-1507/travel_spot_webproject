    ...
    <div className='favourites-section my-4 my-sm-5'>
        <Container>
            ...
            <div className='row g-4'>
                ...
                <div className='col-sm-6 col-lg-3'>
                    <div className='adventure-div img-hover d-flex align-items-end justify-content-center rounded'>
                        <h4 className='text-light mb-4 h2 fw-semibold'>Adventure</h4>
                    </div>
                </div>
                <div className='col-sm-6 col-lg-3'>
                ...
                <div className='col-sm-6 col-lg-3'>
                    <div className='games-div img-hover d-flex align-items-end justify-content-center rounded'>
                        <h4 className='text-light text-capitalize mb-4 h2 fw-semibold'>Games</h4>
                    </div>
                </div>
            </div>
        </Container>
